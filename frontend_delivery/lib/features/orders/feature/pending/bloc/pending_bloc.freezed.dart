...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PendingEvent);
}
...
/// @nodoc
class $PendingEventCopyWith<$Res>  {
$PendingEventCopyWith(PendingEvent _, $Res Function(PendingEvent) __);
}
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _FetchOrders value)?  fetchOrders,TResult Function( _ApproveOrder value)?  approveOrder,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _FetchOrders() when fetchOrders != null:
return fetchOrders(_that);case _ApproveOrder() when approveOrder != null:
return approveOrder(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _FetchOrders value)  fetchOrders,required TResult Function( _ApproveOrder value)  approveOrder,}){
final _that = this;
switch (_that) {
case _FetchOrders():
return fetchOrders(_that);case _ApproveOrder():
return approveOrder(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _FetchOrders value)?  fetchOrders,TResult? Function( _ApproveOrder value)?  approveOrder,}){
final _that = this;
switch (_that) {
case _FetchOrders() when fetchOrders != null:
return fetchOrders(_that);case _ApproveOrder() when approveOrder != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  fetchOrders,TResult Function( int orderId)?  approveOrder,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FetchOrders() when fetchOrders != null:
return fetchOrders();case _ApproveOrder() when approveOrder != null:
return approveOrder(_that.orderId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  fetchOrders,required TResult Function( int orderId)  approveOrder,}) {final _that = this;
switch (_that) {
case _FetchOrders():
return fetchOrders();case _ApproveOrder():
return approveOrder(_that.orderId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  fetchOrders,TResult? Function( int orderId)?  approveOrder,}) {final _that = this;
switch (_that) {
case _FetchOrders() when fetchOrders != null:
return fetchOrders();case _ApproveOrder() when approveOrder != null:
return approveOrder(_that.orderId);case _:
...
class _FetchOrders implements PendingEvent {
  const _FetchOrders();
...
@override
String toString() {
  return 'PendingEvent.fetchOrders()';
}
...
class _ApproveOrder implements PendingEvent {
  const _ApproveOrder({required this.orderId});
...
_$ApproveOrderCopyWith<_ApproveOrder> get copyWith => __$ApproveOrderCopyWithImpl<_ApproveOrder>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ApproveOrder&&(identical(other.orderId, orderId) || other.orderId == orderId));
}
...
@override
String toString() {
  return 'PendingEvent.approveOrder(orderId: $orderId)';
}
...
/// @nodoc
abstract mixin class _$ApproveOrderCopyWith<$Res> implements $PendingEventCopyWith<$Res> {
  factory _$ApproveOrderCopyWith(_ApproveOrder value, $Res Function(_ApproveOrder) _then) = __$ApproveOrderCopyWithImpl;
@useResult
$Res call({
 int orderId
});
...
/// @nodoc
class __$ApproveOrderCopyWithImpl<$Res>
    implements _$ApproveOrderCopyWith<$Res> {
  __$ApproveOrderCopyWithImpl(this._self, this._then);

  final _ApproveOrder _self;
  final $Res Function(_ApproveOrder) _then;

/// Create a copy of PendingEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? orderId = null,}) {
  return _then(_ApproveOrder(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<OrderModel> orders,  String? message)?  loaded,TResult Function( String message)?  empty,TResult Function( String message)?  serverFailure,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Loaded() when loaded != null:
return loaded(_that.orders,_that.message);case _Empty() when empty != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<OrderModel> orders,  String? message)  loaded,required TResult Function( String message)  empty,required TResult Function( String message)  serverFailure,}) {final _that = this;
switch (_that) {
case _Initial():
return initial();case _Loading():
return loading();case _Loaded():
return loaded(_that.orders,_that.message);case _Empty():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<OrderModel> orders,  String? message)?  loaded,TResult? Function( String message)?  empty,TResult? Function( String message)?  serverFailure,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Loaded() when loaded != null:
...
class _Initial implements PendingState {
  const _Initial();
...
class _Loading implements PendingState {
  const _Loading();
...
@override
String toString() {
  return 'PendingState.loaded(orders: $orders, message: $message)';
}
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $PendingStateCopyWith<$Res> {
...
class _ServerFailure implements PendingState {
...
@override
String toString() {
  return 'PendingState.serverFailure(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ServerFailureCopyWith<$Res> implements $PendingStateCopyWith<$Res> {
