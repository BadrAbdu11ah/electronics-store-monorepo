...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _FetchOrders value)?  fetchOrders,TResult Function( _DoneDelivery value)?  doneDelivery,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _FetchOrders() when fetchOrders != null:
return fetchOrders(_that);case _DoneDelivery() when doneDelivery != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _FetchOrders value)  fetchOrders,required TResult Function( _DoneDelivery value)  doneDelivery,}){
final _that = this;
switch (_that) {
case _FetchOrders():
return fetchOrders(_that);case _DoneDelivery():
return doneDelivery(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _FetchOrders value)?  fetchOrders,TResult? Function( _DoneDelivery value)?  doneDelivery,}){
final _that = this;
switch (_that) {
case _FetchOrders() when fetchOrders != null:
return fetchOrders(_that);case _DoneDelivery() when doneDelivery != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  fetchOrders,TResult Function( int orderId)?  doneDelivery,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FetchOrders() when fetchOrders != null:
return fetchOrders();case _DoneDelivery() when doneDelivery != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  fetchOrders,required TResult Function( int orderId)  doneDelivery,}) {final _that = this;
switch (_that) {
case _FetchOrders():
return fetchOrders();case _DoneDelivery():
return doneDelivery(_that.orderId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  fetchOrders,TResult? Function( int orderId)?  doneDelivery,}) {final _that = this;
switch (_that) {
case _FetchOrders() when fetchOrders != null:
return fetchOrders();case _DoneDelivery() when doneDelivery != null:
return doneDelivery(_that.orderId);case _:
...
class _DoneDelivery implements AccepteEvent {
...
@override
String toString() {
  return 'AccepteEvent.doneDelivery(orderId: $orderId)';
}
...
/// @nodoc
abstract mixin class _$DoneDeliveryCopyWith<$Res> implements $AccepteEventCopyWith<$Res> {
