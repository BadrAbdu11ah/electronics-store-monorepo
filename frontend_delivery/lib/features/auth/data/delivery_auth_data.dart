...
import 'package:electronics_store_delivery/core/services/auth_service.dart';
import 'package:fpdart/fpdart.dart';

class DeliveryAuthData {
  final ApiService apiService;
  final AppService appService = AppService();
  final AuthService authService = AuthService();

  DeliveryAuthData(this.apiService);
  ...
  // 2. تفعيل الحساب عن طريق كود التحقق
  ...
  // 3. المرحلة الأولى: التأكد من وجود البريد الإلكتروني لإرسال رمز التحقق (نسيان كلمة المرور)
