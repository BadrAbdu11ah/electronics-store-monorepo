...
import 'package:electronics_store_delivery/features/auth/feature/forget_password_features/forget_password/widgets/forget_password_form.dart';
...
class _ForgetPasswordViewState extends State<ForgetPasswordView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:
          BlocConsumer<DeliveryForgetPasswordBloc, DeliveryForgetPasswordState>(
              ...
              state.maybeWhen(
                ...
                failure: (errorKey) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text(
                        AppTranslations.translate(context, errorKey),
                      ),
            ...
            builder: (context, state) {
              ...
              return state.maybeWhen(
                serverFailure: (errorKey) => AppErrorWidget(
                  message: errorKey,
                  onRetry: () => context.read<DeliveryForgetPasswordBloc>().add(
                    const DeliveryForgetPasswordEvent.resetPage(),
                  ),
                ),
