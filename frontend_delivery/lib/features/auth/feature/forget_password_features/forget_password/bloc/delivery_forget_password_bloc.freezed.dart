...
/// @nodoc
mixin _$DeliveryForgetPasswordEvent {
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DeliveryForgetPasswordEvent);
}
...
@override
String toString() {
  return 'DeliveryForgetPasswordEvent()';
}
...
/// @nodoc
class $DeliveryForgetPasswordEventCopyWith<$Res>  {
$DeliveryForgetPasswordEventCopyWith(DeliveryForgetPasswordEvent _, $Res Function(DeliveryForgetPasswordEvent) __);
}


/// Adds pattern-matching-related methods to [DeliveryForgetPasswordEvent].
extension DeliveryForgetPasswordEventPatterns on DeliveryForgetPasswordEvent {
...
class _CheckEmail implements DeliveryForgetPasswordEvent {
  const _CheckEmail(this.email);
  

 final  String email;

/// Create a copy of DeliveryForgetPasswordEvent
...
@override
String toString() {
  return 'DeliveryForgetPasswordEvent.checkEmail(email: $email)';
}
...
/// @nodoc
abstract mixin class _$CheckEmailCopyWith<$Res> implements $DeliveryForgetPasswordEventCopyWith<$Res> {
...
class _ResetPage implements DeliveryForgetPasswordEvent {
  const _ResetPage();
...
@override
String toString() {
  return 'DeliveryForgetPasswordEvent.resetPage()';
}
...
/// @nodoc
mixin _$DeliveryForgetPasswordState {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DeliveryForgetPasswordState);
}
...
@override
String toString() {
  return 'DeliveryForgetPasswordState()';
}
...
/// @nodoc
class $DeliveryForgetPasswordStateCopyWith<$Res>  {
$DeliveryForgetPasswordStateCopyWith(DeliveryForgetPasswordState _, $Res Function(DeliveryForgetPasswordState) __);
}


/// Adds pattern-matching-related methods to [DeliveryForgetPasswordState].
extension DeliveryForgetPasswordStatePatterns on DeliveryForgetPasswordState {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
class _Initial implements DeliveryForgetPasswordState {
  const _Initial();
...
@override
String toString() {
  return 'DeliveryForgetPasswordState.initial()';
}
...
class _Loading implements DeliveryForgetPasswordState {
  const _Loading();
...
@override
String toString() {
  return 'DeliveryForgetPasswordState.loading()';
}
...
class _Success implements DeliveryForgetPasswordState {
  const _Success();
...
@override
String toString() {
  return 'DeliveryForgetPasswordState.success()';
}
...
class _Failure implements DeliveryForgetPasswordState {
  const _Failure(this.errorKey);
  

 final  String errorKey;

/// Create a copy of DeliveryForgetPasswordState
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
...
@override
String toString() {
  return 'DeliveryForgetPasswordState.failure(errorKey: $errorKey)';
}
...
/// @nodoc
abstract mixin class _$FailureCopyWith<$Res> implements $DeliveryForgetPasswordStateCopyWith<$Res> {
...
class _ServerFailure implements DeliveryForgetPasswordState {
...
@override
String toString() {
  return 'DeliveryForgetPasswordState.serverFailure(errorMessage: $errorMessage)';
}
...
/// @nodoc
abstract mixin class _$ServerFailureCopyWith<$Res> implements $DeliveryForgetPasswordStateCopyWith<$Res> {
