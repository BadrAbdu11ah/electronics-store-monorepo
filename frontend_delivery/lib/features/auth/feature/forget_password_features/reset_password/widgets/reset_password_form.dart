import 'package:electronics_store_delivery/core/function/valid_input.dart';
...
import 'package:electronics_store_delivery/features/auth/widgets/custom_button_auth.dart';
import 'package:electronics_store_delivery/features/auth/widgets/custom_text_body_auth.dart';
import 'package:electronics_store_delivery/features/auth/widgets/custom_text_form_auth.dart';
                ...
                CustomButtonAuth(
                  ...
                  onPressed: () {
                    ...
                    if (widget.password.text != widget.rePassword.text) {
                      context.read<DeliveryResetPasswordBloc>().add(
                        DeliveryResetPasswordEvent.thePasswordDoesNotMatch(),
                      );
                      return;
                    }
                    context.read<DeliveryResetPasswordBloc>().add(
                      DeliveryResetPasswordEvent.resetPassword(
                        email: widget.email,
