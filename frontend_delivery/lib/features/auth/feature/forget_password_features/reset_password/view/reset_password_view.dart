...
import 'package:electronics_store_delivery/features/auth/feature/forget_password_features/reset_password/widgets/reset_password_form.dart';
...
class _ResetPasswordViewState extends State<ResetPasswordView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocConsumer<DeliveryResetPasswordBloc, DeliveryResetPasswordState>(
        ...
        builder: (context, state) {
          ...
          return state.maybeWhen(
            serverFailure: (errorMessage) => AppErrorWidget(
              ...
              onRetry: () => context.read<DeliveryResetPasswordBloc>().add(
                DeliveryResetPasswordEvent.resetPage(),
              ),
            ),
