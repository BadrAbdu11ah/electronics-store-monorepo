...
/// @nodoc
mixin _$DeliveryVerfiyCodeEvent {
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DeliveryVerfiyCodeEvent);
}
...
@override
String toString() {
  return 'DeliveryVerfiyCodeEvent()';
}
...
/// @nodoc
class $DeliveryVerfiyCodeEventCopyWith<$Res>  {
$DeliveryVerfiyCodeEventCopyWith(DeliveryVerfiyCodeEvent _, $Res Function(DeliveryVerfiyCodeEvent) __);
}


/// Adds pattern-matching-related methods to [DeliveryVerfiyCodeEvent].
extension DeliveryVerfiyCodeEventPatterns on DeliveryVerfiyCodeEvent {
...
class _Submitted implements DeliveryVerfiyCodeEvent {
...
/// Create a copy of DeliveryVerfiyCodeEvent
...
@override
String toString() {
  return 'DeliveryVerfiyCodeEvent.submitted(email: $email, verificationCode: $verificationCode)';
}
...
/// @nodoc
abstract mixin class _$SubmittedCopyWith<$Res> implements $DeliveryVerfiyCodeEventCopyWith<$Res> {
...
class _Reset implements DeliveryVerfiyCodeEvent {
  const _Reset();
...
@override
String toString() {
  return 'DeliveryVerfiyCodeEvent.reset()';
}
...
/// @nodoc
mixin _$DeliveryVerfiyCodeState {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DeliveryVerfiyCodeState);
}
...
@override
String toString() {
  return 'DeliveryVerfiyCodeState()';
}
...
/// @nodoc
class $DeliveryVerfiyCodeStateCopyWith<$Res>  {
$DeliveryVerfiyCodeStateCopyWith(DeliveryVerfiyCodeState _, $Res Function(DeliveryVerfiyCodeState) __);
}


/// Adds pattern-matching-related methods to [DeliveryVerfiyCodeState].
extension DeliveryVerfiyCodeStatePatterns on DeliveryVerfiyCodeState {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
class _Initial implements DeliveryVerfiyCodeState {
  const _Initial();
...
@override
String toString() {
  return 'DeliveryVerfiyCodeState.initial()';
}
...
class _Loading implements DeliveryVerfiyCodeState {
  const _Loading();
...
@override
String toString() {
  return 'DeliveryVerfiyCodeState.loading()';
}
...
class _Success implements DeliveryVerfiyCodeState {
  const _Success();
...
@override
String toString() {
  return 'DeliveryVerfiyCodeState.success()';
}
...
class _ServerFailure implements DeliveryVerfiyCodeState {
  const _ServerFailure(this.errorMessage);
  

 final  String errorMessage;

/// Create a copy of DeliveryVerfiyCodeState
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
...
@override
String toString() {
  return 'DeliveryVerfiyCodeState.serverFailure(errorMessage: $errorMessage)';
}
...
/// @nodoc
abstract mixin class _$ServerFailureCopyWith<$Res> implements $DeliveryVerfiyCodeStateCopyWith<$Res> {
...
class _Failure implements DeliveryVerfiyCodeState {
...
@override
String toString() {
  return 'DeliveryVerfiyCodeState.failure(errorKey: $errorKey)';
}
...
/// @nodoc
abstract mixin class _$FailureCopyWith<$Res> implements $DeliveryVerfiyCodeStateCopyWith<$Res> {
