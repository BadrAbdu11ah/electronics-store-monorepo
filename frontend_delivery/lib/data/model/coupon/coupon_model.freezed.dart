...
mixin _$CouponModel {
 ...
 int? get id; String? get name; int? get count; String? get expiredAt; int? get discount; String? get createdAt; String? get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,count,expiredAt,discount,createdAt,updatedAt);

@override
String toString() {
  return 'CouponModel(id: $id, name: $name, count: $count, expiredAt: $expiredAt, discount: $discount, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 int? id, String? name, int? count, String? expiredAt, int? discount, String? createdAt, String? updatedAt
});
...
/// Create a copy of CouponModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? name = freezed,Object? count = freezed,Object? expiredAt = freezed,Object? discount = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  String? name,  int? count,  String? expiredAt,  int? discount,  String? createdAt,  String? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CouponModel() when $default != null:
return $default(_that.id,_that.name,_that.count,_that.expiredAt,_that.discount,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  String? name,  int? count,  String? expiredAt,  int? discount,  String? createdAt,  String? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _CouponModel():
return $default(_that.id,_that.name,_that.count,_that.expiredAt,_that.discount,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  String? name,  int? count,  String? expiredAt,  int? discount,  String? createdAt,  String? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _CouponModel() when $default != null:
return $default(_that.id,_that.name,_that.count,_that.expiredAt,_that.discount,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _CouponModel extends CouponModel {
  const _CouponModel({this.id, this.name, this.count, this.expiredAt, this.discount, this.createdAt, this.updatedAt}): super._();
...
/// Create a copy of CouponModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? name = freezed,Object? count = freezed,Object? expiredAt = freezed,Object? discount = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
