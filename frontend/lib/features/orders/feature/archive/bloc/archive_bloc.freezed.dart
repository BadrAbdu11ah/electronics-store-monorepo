...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _FetchOrders value)?  fetchOrders,TResult Function( _RateOrder value)?  rateOrder,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _FetchOrders() when fetchOrders != null:
return fetchOrders(_that);case _RateOrder() when rateOrder != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _FetchOrders value)  fetchOrders,required TResult Function( _RateOrder value)  rateOrder,}){
final _that = this;
switch (_that) {
case _FetchOrders():
return fetchOrders(_that);case _RateOrder():
return rateOrder(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _FetchOrders value)?  fetchOrders,TResult? Function( _RateOrder value)?  rateOrder,}){
final _that = this;
switch (_that) {
case _FetchOrders() when fetchOrders != null:
return fetchOrders(_that);case _RateOrder() when rateOrder != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  fetchOrders,TResult Function( int orderId,  double rating,  String comment)?  rateOrder,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FetchOrders() when fetchOrders != null:
return fetchOrders();case _RateOrder() when rateOrder != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  fetchOrders,required TResult Function( int orderId,  double rating,  String comment)  rateOrder,}) {final _that = this;
switch (_that) {
case _FetchOrders():
return fetchOrders();case _RateOrder():
return rateOrder(_that.orderId,_that.rating,_that.comment);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  fetchOrders,TResult? Function( int orderId,  double rating,  String comment)?  rateOrder,}) {final _that = this;
switch (_that) {
case _FetchOrders() when fetchOrders != null:
return fetchOrders();case _RateOrder() when rateOrder != null:
return rateOrder(_that.orderId,_that.rating,_that.comment);case _:
...
class _RateOrder implements ArchiveEvent {
  const _RateOrder({required this.orderId, required this.rating, required this.comment});
...
@override
String toString() {
  return 'ArchiveEvent.rateOrder(orderId: $orderId, rating: $rating, comment: $comment)';
}
...
/// @nodoc
abstract mixin class _$RateOrderCopyWith<$Res> implements $ArchiveEventCopyWith<$Res> {
  factory _$RateOrderCopyWith(_RateOrder value, $Res Function(_RateOrder) _then) = __$RateOrderCopyWithImpl;
@useResult
$Res call({
 int orderId, double rating, String comment
});
...
/// Create a copy of ArchiveEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? orderId = null,Object? rating = null,Object? comment = null,}) {
