...
mixin _$OrderDetailsModel {
 ...
 List<CartModel> get cartItems; AddressModel? get address; OrderModel get orderInfo;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is OrderDetailsModel&&const DeepCollectionEquality().equals(other.cartItems, cartItems)&&(identical(other.address, address) || other.address == address)&&(identical(other.orderInfo, orderInfo) || other.orderInfo == orderInfo));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(cartItems),address,orderInfo);

@override
String toString() {
  return 'OrderDetailsModel(cartItems: $cartItems, address: $address, orderInfo: $orderInfo)';
}
...
@useResult
$Res call({
 List<CartModel> cartItems, AddressModel? address, OrderModel orderInfo
});


$AddressModelCopyWith<$Res>? get address;$OrderModelCopyWith<$Res> get orderInfo;
...
/// Create a copy of OrderDetailsModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? cartItems = null,Object? address = freezed,Object? orderInfo = null,}) {
  return _then(_self.copyWith(
cartItems: null == cartItems ? _self.cartItems : cartItems // ignore: cast_nullable_to_non_nullable
as List<CartModel>,address: freezed == address ? _self.address : address // ignore: cast_nullable_to_non_nullable
as AddressModel?,orderInfo: null == orderInfo ? _self.orderInfo : orderInfo // ignore: cast_nullable_to_non_nullable
as OrderModel,
  ));
}
/// Create a copy of OrderDetailsModel
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<CartModel> cartItems,  AddressModel? address,  OrderModel orderInfo)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OrderDetailsModel() when $default != null:
return $default(_that.cartItems,_that.address,_that.orderInfo);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<CartModel> cartItems,  AddressModel? address,  OrderModel orderInfo)  $default,) {final _that = this;
switch (_that) {
case _OrderDetailsModel():
return $default(_that.cartItems,_that.address,_that.orderInfo);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<CartModel> cartItems,  AddressModel? address,  OrderModel orderInfo)?  $default,) {final _that = this;
switch (_that) {
case _OrderDetailsModel() when $default != null:
return $default(_that.cartItems,_that.address,_that.orderInfo);case _:
  return null;
...
class _OrderDetailsModel extends OrderDetailsModel {
  const _OrderDetailsModel({required final  List<CartModel> cartItems, required this.address, required this.orderInfo}): _cartItems = cartItems,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _OrderDetailsModel&&const DeepCollectionEquality().equals(other._cartItems, _cartItems)&&(identical(other.address, address) || other.address == address)&&(identical(other.orderInfo, orderInfo) || other.orderInfo == orderInfo));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_cartItems),address,orderInfo);
...
@override $AddressModelCopyWith<$Res>? get address;@override $OrderModelCopyWith<$Res> get orderInfo;
...
/// Create a copy of OrderDetailsModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? cartItems = null,Object? address = freezed,Object? orderInfo = null,}) {
