...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is VerfiyCodeSignUpEvent);
}
...
/// @nodoc
class $VerfiyCodeSignUpEventCopyWith<$Res>  {
$VerfiyCodeSignUpEventCopyWith(VerfiyCodeSignUpEvent _, $Res Function(VerfiyCodeSignUpEvent) __);
}


/// Adds pattern-matching-related methods to [VerfiyCodeSignUpEvent].
extension VerfiyCodeSignUpEventPatterns on VerfiyCodeSignUpEvent {
...
class _Submitted implements VerfiyCodeSignUpEvent {
...
/// @nodoc
abstract mixin class _$SubmittedCopyWith<$Res> implements $VerfiyCodeSignUpEventCopyWith<$Res> {
...
class _Reset implements VerfiyCodeSignUpEvent {
  const _Reset();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is VerfiyCodeSignUpState);
}
...
/// @nodoc
class $VerfiyCodeSignUpStateCopyWith<$Res>  {
$VerfiyCodeSignUpStateCopyWith(VerfiyCodeSignUpState _, $Res Function(VerfiyCodeSignUpState) __);
}


/// Adds pattern-matching-related methods to [VerfiyCodeSignUpState].
extension VerfiyCodeSignUpStatePatterns on VerfiyCodeSignUpState {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
class _Initial implements VerfiyCodeSignUpState {
  const _Initial();
...
class _Loading implements VerfiyCodeSignUpState {
  const _Loading();
...
class _Success implements VerfiyCodeSignUpState {
  const _Success();
...
class _ServerFailure implements VerfiyCodeSignUpState {
...
/// @nodoc
abstract mixin class _$ServerFailureCopyWith<$Res> implements $VerfiyCodeSignUpStateCopyWith<$Res> {
...
class _Failure implements VerfiyCodeSignUpState {
...
/// @nodoc
abstract mixin class _$FailureCopyWith<$Res> implements $VerfiyCodeSignUpStateCopyWith<$Res> {
