...
class VerfiyCodeSignUpForm extends StatelessWidget {
  final String email;
  const VerfiyCodeSignUpForm({super.key, required this.email});
        ...
        children: [
          ...
          OtpTextField(
            ...
            onSubmit: (String verificationCode) {
              context.read<VerfiyCodeSignUpBloc>().add(
                VerfiyCodeSignUpEvent.submitted(
                  email: email,
