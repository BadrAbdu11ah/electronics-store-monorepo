...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CartResponseModel&&(identical(other.status, status) || other.status == status)&&const DeepCollectionEquality().equals(other.items, items)&&(identical(other.coupon, coupon) || other.coupon == coupon)&&(identical(other.subtotal, subtotal) || other.subtotal == subtotal)&&(identical(other.discountAmount, discountAmount) || other.discountAmount == discountAmount)&&(identical(other.shippingPrice, shippingPrice) || other.shippingPrice == shippingPrice)&&(identical(other.totalPrice, totalPrice) || other.totalPrice == totalPrice)&&(identical(other.totalQuantity, totalQuantity) || other.totalQuantity == totalQuantity));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,status,const DeepCollectionEquality().hash(items),coupon,subtotal,discountAmount,shippingPrice,totalPrice,totalQuantity);

@override
String toString() {
  return 'CartResponseModel(status: $status, items: $items, coupon: $coupon, subtotal: $subtotal, discountAmount: $discountAmount, shippingPrice: $shippingPrice, totalPrice: $totalPrice, totalQuantity: $totalQuantity)';
}
...
@useResult
$Res call({
 String? status, List<CartModel> items, CouponModel? coupon, double? subtotal, double? discountAmount, double? shippingPrice, double? totalPrice, int? totalQuantity
});
...
/// Create a copy of CartResponseModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? status = freezed,Object? items = null,Object? coupon = freezed,Object? subtotal = freezed,Object? discountAmount = freezed,Object? shippingPrice = freezed,Object? totalPrice = freezed,Object? totalQuantity = freezed,}) {
  return _then(_self.copyWith(
status: freezed == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
as String?,items: null == items ? _self.items : items // ignore: cast_nullable_to_non_nullable
as List<CartModel>,coupon: freezed == coupon ? _self.coupon : coupon // ignore: cast_nullable_to_non_nullable
as CouponModel?,subtotal: freezed == subtotal ? _self.subtotal : subtotal // ignore: cast_nullable_to_non_nullable
as double?,discountAmount: freezed == discountAmount ? _self.discountAmount : discountAmount // ignore: cast_nullable_to_non_nullable
as double?,shippingPrice: freezed == shippingPrice ? _self.shippingPrice : shippingPrice // ignore: cast_nullable_to_non_nullable
...
$CouponModelCopyWith<$Res>? get coupon {
  ...
  return $CouponModelCopyWith<$Res>(_self.coupon!, (value) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? status,  List<CartModel> items,  CouponModel? coupon,  double? subtotal,  double? discountAmount,  double? shippingPrice,  double? totalPrice,  int? totalQuantity)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CartResponseModel() when $default != null:
return $default(_that.status,_that.items,_that.coupon,_that.subtotal,_that.discountAmount,_that.shippingPrice,_that.totalPrice,_that.totalQuantity);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? status,  List<CartModel> items,  CouponModel? coupon,  double? subtotal,  double? discountAmount,  double? shippingPrice,  double? totalPrice,  int? totalQuantity)  $default,) {final _that = this;
switch (_that) {
case _CartResponseModel():
return $default(_that.status,_that.items,_that.coupon,_that.subtotal,_that.discountAmount,_that.shippingPrice,_that.totalPrice,_that.totalQuantity);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? status,  List<CartModel> items,  CouponModel? coupon,  double? subtotal,  double? discountAmount,  double? shippingPrice,  double? totalPrice,  int? totalQuantity)?  $default,) {final _that = this;
switch (_that) {
case _CartResponseModel() when $default != null:
return $default(_that.status,_that.items,_that.coupon,_that.subtotal,_that.discountAmount,_that.shippingPrice,_that.totalPrice,_that.totalQuantity);case _:
  return null;
...
class _CartResponseModel extends CartResponseModel {
  const _CartResponseModel({this.status, final  List<CartModel> items = const [], this.coupon, this.subtotal, this.discountAmount, this.shippingPrice, this.totalPrice, this.totalQuantity}): _items = items,super._();
  factory _CartResponseModel.fromJson(Map<String, dynamic> json) => _$CartResponseModelFromJson(json);

@override final  String? status;
 final  List<CartModel> _items;
@override@JsonKey() List<CartModel> get items {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CartResponseModel&&(identical(other.status, status) || other.status == status)&&const DeepCollectionEquality().equals(other._items, _items)&&(identical(other.coupon, coupon) || other.coupon == coupon)&&(identical(other.subtotal, subtotal) || other.subtotal == subtotal)&&(identical(other.discountAmount, discountAmount) || other.discountAmount == discountAmount)&&(identical(other.shippingPrice, shippingPrice) || other.shippingPrice == shippingPrice)&&(identical(other.totalPrice, totalPrice) || other.totalPrice == totalPrice)&&(identical(other.totalQuantity, totalQuantity) || other.totalQuantity == totalQuantity));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,status,const DeepCollectionEquality().hash(_items),coupon,subtotal,discountAmount,shippingPrice,totalPrice,totalQuantity);
...
@override $CouponModelCopyWith<$Res>? get coupon;
...
/// Create a copy of CartResponseModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? status = freezed,Object? items = null,Object? coupon = freezed,Object? subtotal = freezed,Object? discountAmount = freezed,Object? shippingPrice = freezed,Object? totalPrice = freezed,Object? totalQuantity = freezed,}) {
