...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AdminVerfiyCodeEvent);
}
...
/// @nodoc
class $AdminVerfiyCodeEventCopyWith<$Res>  {
$AdminVerfiyCodeEventCopyWith(AdminVerfiyCodeEvent _, $Res Function(AdminVerfiyCodeEvent) __);
}


/// Adds pattern-matching-related methods to [AdminVerfiyCodeEvent].
extension AdminVerfiyCodeEventPatterns on AdminVerfiyCodeEvent {
...
class _Submitted implements AdminVerfiyCodeEvent {
...
/// Create a copy of AdminVerfiyCodeEvent
...
@override
String toString() {
  return 'AdminVerfiyCodeEvent.submitted(email: $email, verificationCode: $verificationCode)';
}
...
/// @nodoc
abstract mixin class _$SubmittedCopyWith<$Res> implements $AdminVerfiyCodeEventCopyWith<$Res> {
...
class _Reset implements AdminVerfiyCodeEvent {
  const _Reset();
...
@override
String toString() {
  return 'AdminVerfiyCodeEvent.reset()';
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AdminVerfiyCodeState);
}
...
/// @nodoc
class $AdminVerfiyCodeStateCopyWith<$Res>  {
$AdminVerfiyCodeStateCopyWith(AdminVerfiyCodeState _, $Res Function(AdminVerfiyCodeState) __);
}


/// Adds pattern-matching-related methods to [AdminVerfiyCodeState].
extension AdminVerfiyCodeStatePatterns on AdminVerfiyCodeState {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
class _Initial implements AdminVerfiyCodeState {
  const _Initial();
...
@override
String toString() {
  return 'AdminVerfiyCodeState.initial()';
}
...
class _Loading implements AdminVerfiyCodeState {
  const _Loading();
...
@override
String toString() {
  return 'AdminVerfiyCodeState.loading()';
}
...
class _Success implements AdminVerfiyCodeState {
  const _Success();
...
@override
String toString() {
  return 'AdminVerfiyCodeState.success()';
}
...
class _ServerFailure implements AdminVerfiyCodeState {
  const _ServerFailure(this.errorMessage);
  

 final  String errorMessage;

/// Create a copy of AdminVerfiyCodeState
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
...
@override
String toString() {
  return 'AdminVerfiyCodeState.serverFailure(errorMessage: $errorMessage)';
}
...
/// @nodoc
abstract mixin class _$ServerFailureCopyWith<$Res> implements $AdminVerfiyCodeStateCopyWith<$Res> {
...
class _Failure implements AdminVerfiyCodeState {
...
@override
String toString() {
  return 'AdminVerfiyCodeState.failure(errorKey: $errorKey)';
}
...
/// @nodoc
abstract mixin class _$FailureCopyWith<$Res> implements $AdminVerfiyCodeStateCopyWith<$Res> {
