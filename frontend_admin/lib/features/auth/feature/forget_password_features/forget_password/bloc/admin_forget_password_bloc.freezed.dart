...
/// @nodoc
mixin _$AdminForgetPasswordEvent {
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AdminForgetPasswordEvent);
}
...
@override
String toString() {
  return 'AdminForgetPasswordEvent()';
}
...
/// @nodoc
class $AdminForgetPasswordEventCopyWith<$Res>  {
$AdminForgetPasswordEventCopyWith(AdminForgetPasswordEvent _, $Res Function(AdminForgetPasswordEvent) __);
}


/// Adds pattern-matching-related methods to [AdminForgetPasswordEvent].
extension AdminForgetPasswordEventPatterns on AdminForgetPasswordEvent {
...
class _CheckEmail implements AdminForgetPasswordEvent {
  const _CheckEmail(this.email);
  

 final  String email;

/// Create a copy of AdminForgetPasswordEvent
...
@override
String toString() {
  return 'AdminForgetPasswordEvent.checkEmail(email: $email)';
}
...
/// @nodoc
abstract mixin class _$CheckEmailCopyWith<$Res> implements $AdminForgetPasswordEventCopyWith<$Res> {
...
class _ResetPage implements AdminForgetPasswordEvent {
  const _ResetPage();
...
@override
String toString() {
  return 'AdminForgetPasswordEvent.resetPage()';
}
...
/// @nodoc
mixin _$AdminForgetPasswordState {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AdminForgetPasswordState);
}
...
@override
String toString() {
  return 'AdminForgetPasswordState()';
}
...
/// @nodoc
class $AdminForgetPasswordStateCopyWith<$Res>  {
$AdminForgetPasswordStateCopyWith(AdminForgetPasswordState _, $Res Function(AdminForgetPasswordState) __);
}


/// Adds pattern-matching-related methods to [AdminForgetPasswordState].
extension AdminForgetPasswordStatePatterns on AdminForgetPasswordState {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
class _Initial implements AdminForgetPasswordState {
  const _Initial();
...
@override
String toString() {
  return 'AdminForgetPasswordState.initial()';
}
...
class _Loading implements AdminForgetPasswordState {
  const _Loading();
...
@override
String toString() {
  return 'AdminForgetPasswordState.loading()';
}
...
class _Success implements AdminForgetPasswordState {
  const _Success();
...
@override
String toString() {
  return 'AdminForgetPasswordState.success()';
}
...
class _Failure implements AdminForgetPasswordState {
  const _Failure(this.errorKey);
  

 final  String errorKey;

/// Create a copy of AdminForgetPasswordState
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
...
@override
String toString() {
  return 'AdminForgetPasswordState.failure(errorKey: $errorKey)';
}
...
/// @nodoc
abstract mixin class _$FailureCopyWith<$Res> implements $AdminForgetPasswordStateCopyWith<$Res> {
...
class _ServerFailure implements AdminForgetPasswordState {
...
@override
String toString() {
  return 'AdminForgetPasswordState.serverFailure(errorMessage: $errorMessage)';
}
...
/// @nodoc
abstract mixin class _$ServerFailureCopyWith<$Res> implements $AdminForgetPasswordStateCopyWith<$Res> {
