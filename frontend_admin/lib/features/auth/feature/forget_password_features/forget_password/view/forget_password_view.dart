...
import 'package:frontend_admin/features/auth/feature/forget_password_features/forget_password/widgets/forget_password_form.dart';
...
class _ForgetPasswordViewState extends State<ForgetPasswordView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocConsumer<AdminForgetPasswordBloc, AdminForgetPasswordState>(
        ...
        builder: (context, state) {
          ...
          return state.maybeWhen(
            serverFailure: (errorKey) => AppErrorWidget(
              message: errorKey,
              onRetry: () => context.read<AdminForgetPasswordBloc>().add(
                const AdminForgetPasswordEvent.resetPage(),
              ),
            ),
