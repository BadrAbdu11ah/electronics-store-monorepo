...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AdminLoginEvent);
}
...
/// @nodoc
class $AdminLoginEventCopyWith<$Res>  {
$AdminLoginEventCopyWith(AdminLoginEvent _, $Res Function(AdminLoginEvent) __);
}


/// Adds pattern-matching-related methods to [AdminLoginEvent].
extension AdminLoginEventPatterns on AdminLoginEvent {
...
class _Submitted implements AdminLoginEvent {
...
/// Create a copy of AdminLoginEvent
...
@override
String toString() {
  return 'AdminLoginEvent.submitted(email: $email, password: $password)';
}
...
/// @nodoc
abstract mixin class _$SubmittedCopyWith<$Res> implements $AdminLoginEventCopyWith<$Res> {
...
class _Reset implements AdminLoginEvent {
  const _Reset();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AdminLoginState);
}
...
/// @nodoc
class $AdminLoginStateCopyWith<$Res>  {
$AdminLoginStateCopyWith(AdminLoginState _, $Res Function(AdminLoginState) __);
}


/// Adds pattern-matching-related methods to [AdminLoginState].
extension AdminLoginStatePatterns on AdminLoginState {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
class _Initial implements AdminLoginState {
  const _Initial();
...
@override
String toString() {
  return 'AdminLoginState.initial()';
}
...
class _Loading implements AdminLoginState {
  const _Loading();
...
@override
String toString() {
  return 'AdminLoginState.loading()';
}
...
class _Success implements AdminLoginState {
  const _Success();
...
@override
String toString() {
  return 'AdminLoginState.success()';
}
...
class _ServerFailure implements AdminLoginState {
...
@override
String toString() {
  return 'AdminLoginState.serverFailure(errorMessage: $errorMessage)';
}
...
/// @nodoc
abstract mixin class _$ServerFailureCopyWith<$Res> implements $AdminLoginStateCopyWith<$Res> {
...
class _Failure implements AdminLoginState {
...
@override
String toString() {
  return 'AdminLoginState.failure(errorMessage: $errorMessage)';
}
...
/// @nodoc
abstract mixin class _$FailureCopyWith<$Res> implements $AdminLoginStateCopyWith<$Res> {
