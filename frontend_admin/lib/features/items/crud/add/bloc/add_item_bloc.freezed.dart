...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AddItemStatus);
}
...
/// @nodoc
class $AddItemStatusCopyWith<$Res>  {
$AddItemStatusCopyWith(AddItemStatus _, $Res Function(AddItemStatus) __);
}


/// Adds pattern-matching-related methods to [AddItemStatus].
extension AddItemStatusPatterns on AddItemStatus {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _Initial value)?  initial,TResult Function( _Loading value)?  loading,TResult Function( _ServerFailure value)?  serverFailure,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _Initial value)  initial,required TResult Function( _Loading value)  loading,required TResult Function( _ServerFailure value)  serverFailure,}){
final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _Initial value)?  initial,TResult? Function( _Loading value)?  loading,TResult? Function( _ServerFailure value)?  serverFailure,}){
final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial(_that);case _Loading() when loading != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( String message)?  serverFailure,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( String message)  serverFailure,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( String message)?  serverFailure,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _ServerFailure() when serverFailure != null:
...
class _Initial implements AddItemStatus {
  const _Initial();
...
class _Loading implements AddItemStatus {
  const _Loading();
...
class _ServerFailure implements AddItemStatus {
  const _ServerFailure(this.message);
  

 final  String message;

/// Create a copy of AddItemStatus
...
@override
String toString() {
  return 'AddItemStatus.serverFailure(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ServerFailureCopyWith<$Res> implements $AddItemStatusCopyWith<$Res> {
...
mixin _$AddItemState {
 ...
 AddItemStatus get status; CategoriesStatus get categoriesStatus; SnackBarStatus get snackBarStatus; File? get image; CategoryModel? get category;
...
@override
int get hashCode => Object.hash(runtimeType,status,categoriesStatus,snackBarStatus,image,category);

@override
String toString() {
  return 'AddItemState(status: $status, categoriesStatus: $categoriesStatus, snackBarStatus: $snackBarStatus, image: $image, category: $category)';
}
...
@useResult
$Res call({
 AddItemStatus status, CategoriesStatus categoriesStatus, SnackBarStatus snackBarStatus, File? image, CategoryModel? category
});


$AddItemStatusCopyWith<$Res> get status;$CategoriesStatusCopyWith<$Res> get categoriesStatus;$SnackBarStatusCopyWith<$Res> get snackBarStatus;$CategoryModelCopyWith<$Res>? get category;
...
/// Create a copy of AddItemState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? status = null,Object? categoriesStatus = null,Object? snackBarStatus = null,Object? image = freezed,Object? category = freezed,}) {
  return _then(_self.copyWith(
status: null == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
as AddItemStatus,categoriesStatus: null == categoriesStatus ? _self.categoriesStatus : categoriesStatus // ignore: cast_nullable_to_non_nullable
as CategoriesStatus,snackBarStatus: null == snackBarStatus ? _self.snackBarStatus : snackBarStatus // ignore: cast_nullable_to_non_nullable
as SnackBarStatus,image: freezed == image ? _self.image : image // ignore: cast_nullable_to_non_nullable
as File?,category: freezed == category ? _self.category : category // ignore: cast_nullable_to_non_nullable
as CategoryModel?,
  ));
}
/// Create a copy of AddItemState
...
@override
@pragma('vm:prefer-inline')
$AddItemStatusCopyWith<$Res> get status {
  
  return $AddItemStatusCopyWith<$Res>(_self.status, (value) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( AddItemStatus status,  CategoriesStatus categoriesStatus,  SnackBarStatus snackBarStatus,  File? image,  CategoryModel? category)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AddItemState() when $default != null:
return $default(_that.status,_that.categoriesStatus,_that.snackBarStatus,_that.image,_that.category);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( AddItemStatus status,  CategoriesStatus categoriesStatus,  SnackBarStatus snackBarStatus,  File? image,  CategoryModel? category)  $default,) {final _that = this;
switch (_that) {
case _AddItemState():
return $default(_that.status,_that.categoriesStatus,_that.snackBarStatus,_that.image,_that.category);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( AddItemStatus status,  CategoriesStatus categoriesStatus,  SnackBarStatus snackBarStatus,  File? image,  CategoryModel? category)?  $default,) {final _that = this;
switch (_that) {
case _AddItemState() when $default != null:
return $default(_that.status,_that.categoriesStatus,_that.snackBarStatus,_that.image,_that.category);case _:
  return null;
...
class _AddItemState implements AddItemState {
  const _AddItemState({this.status = const AddItemStatus.initial(), this.categoriesStatus = const CategoriesStatus.initial(), this.snackBarStatus = const SnackBarStatus.initial(), this.image, this.category});
  

@override@JsonKey() final  AddItemStatus status;
...
@override $AddItemStatusCopyWith<$Res> get status;@override $CategoriesStatusCopyWith<$Res> get categoriesStatus;@override $SnackBarStatusCopyWith<$Res> get snackBarStatus;@override $CategoryModelCopyWith<$Res>? get category;
...
/// Create a copy of AddItemState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? status = null,Object? categoriesStatus = null,Object? snackBarStatus = null,Object? image = freezed,Object? category = freezed,}) {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AddItemEvent);
}
...
/// @nodoc
class $AddItemEventCopyWith<$Res>  {
$AddItemEventCopyWith(AddItemEvent _, $Res Function(AddItemEvent) __);
}
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _Started value)?  started,TResult Function( _LoadCategories value)?  loadCategories,TResult Function( _Submit value)?  submit,TResult Function( _SetImege value)?  setImage,TResult Function( _SetCategory value)?  setCategory,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
return setCategory(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _Started value)  started,required TResult Function( _LoadCategories value)  loadCategories,required TResult Function( _Submit value)  submit,required TResult Function( _SetImege value)  setImage,required TResult Function( _SetCategory value)  setCategory,}){
final _that = this;
switch (_that) {
case _Started():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _Started value)?  started,TResult? Function( _LoadCategories value)?  loadCategories,TResult? Function( _Submit value)?  submit,TResult? Function( _SetImege value)?  setImage,TResult? Function( _SetCategory value)?  setCategory,}){
final _that = this;
switch (_that) {
case _Started() when started != null:
return started(_that);case _LoadCategories() when loadCategories != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  started,TResult Function()?  loadCategories,TResult Function( String name,  String nameAr,  String description,  String descriptionAr,  int count,  int active,  double price,  double discount,  int deliveryTime)?  submit,TResult Function( File file)?  setImage,TResult Function( CategoryModel category)?  setCategory,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started();case _LoadCategories() when loadCategories != null:
return loadCategories();case _Submit() when submit != null:
return submit(_that.name,_that.nameAr,_that.description,_that.descriptionAr,_that.count,_that.active,_that.price,_that.discount,_that.deliveryTime);case _SetImege() when setImage != null:
return setImage(_that.file);case _SetCategory() when setCategory != null:
return setCategory(_that.category);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  started,required TResult Function()  loadCategories,required TResult Function( String name,  String nameAr,  String description,  String descriptionAr,  int count,  int active,  double price,  double discount,  int deliveryTime)  submit,required TResult Function( File file)  setImage,required TResult Function( CategoryModel category)  setCategory,}) {final _that = this;
switch (_that) {
case _Started():
return started();case _LoadCategories():
return loadCategories();case _Submit():
return submit(_that.name,_that.nameAr,_that.description,_that.descriptionAr,_that.count,_that.active,_that.price,_that.discount,_that.deliveryTime);case _SetImege():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  started,TResult? Function()?  loadCategories,TResult? Function( String name,  String nameAr,  String description,  String descriptionAr,  int count,  int active,  double price,  double discount,  int deliveryTime)?  submit,TResult? Function( File file)?  setImage,TResult? Function( CategoryModel category)?  setCategory,}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started();case _LoadCategories() when loadCategories != null:
return loadCategories();case _Submit() when submit != null:
...
class _Started implements AddItemEvent {
  const _Started();
...
class _LoadCategories implements AddItemEvent {
...
@override
String toString() {
  return 'AddItemEvent.loadCategories()';
}
...
class _Submit implements AddItemEvent {
  const _Submit({required this.name, required this.nameAr, required this.description, required this.descriptionAr, required this.count, required this.active, required this.price, required this.discount, required this.deliveryTime});
...
@override
int get hashCode => Object.hash(runtimeType,name,nameAr,description,descriptionAr,count,active,price,discount,deliveryTime);

@override
String toString() {
  return 'AddItemEvent.submit(name: $name, nameAr: $nameAr, description: $description, descriptionAr: $descriptionAr, count: $count, active: $active, price: $price, discount: $discount, deliveryTime: $deliveryTime)';
}
...
/// @nodoc
abstract mixin class _$SubmitCopyWith<$Res> implements $AddItemEventCopyWith<$Res> {
  factory _$SubmitCopyWith(_Submit value, $Res Function(_Submit) _then) = __$SubmitCopyWithImpl;
@useResult
$Res call({
 String name, String nameAr, String description, String descriptionAr, int count, int active, double price, double discount, int deliveryTime
});
...
/// Create a copy of AddItemEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? name = null,Object? nameAr = null,Object? description = null,Object? descriptionAr = null,Object? count = null,Object? active = null,Object? price = null,Object? discount = null,Object? deliveryTime = null,}) {
...
class _SetImege implements AddItemEvent {
...
/// @nodoc
abstract mixin class _$SetImegeCopyWith<$Res> implements $AddItemEventCopyWith<$Res> {
...
class _SetCategory implements AddItemEvent {
...
@override
String toString() {
  return 'AddItemEvent.setCategory(category: $category)';
}
...
/// @nodoc
abstract mixin class _$SetCategoryCopyWith<$Res> implements $AddItemEventCopyWith<$Res> {
