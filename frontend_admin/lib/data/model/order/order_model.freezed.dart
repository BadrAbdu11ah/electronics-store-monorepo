...
mixin _$OrderModel {
 ...
 int? get status; int? get deliveryId; double? get rating; String? get review; String? get createdAt; String? get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,userId,addressId,addressName,addressCity,addressStreet,addressLat,addressLong,type,deliveryPrice,price,discountAmount,discountRate,totalPrice,couponId,couponName,paymentMethod,status,deliveryId,rating,review,createdAt,updatedAt]);

@override
String toString() {
  return 'OrderModel(id: $id, userId: $userId, addressId: $addressId, addressName: $addressName, addressCity: $addressCity, addressStreet: $addressStreet, addressLat: $addressLat, addressLong: $addressLong, type: $type, deliveryPrice: $deliveryPrice, price: $price, discountAmount: $discountAmount, discountRate: $discountRate, totalPrice: $totalPrice, couponId: $couponId, couponName: $couponName, paymentMethod: $paymentMethod, status: $status, deliveryId: $deliveryId, rating: $rating, review: $review, createdAt: $createdAt, updatedAt: $updatedAt)';
}
