...
Map<String, String> errorMessagesAr = {
  ...
  AppText.deleteCategory: "حذف القسم",
  AppText.deleteItem: "حذف المنتج",
  ...
  AppText.areYouSureYouWantToDeleteThisItem:
      "هل أنت متأكد من رغبتك في حذف هذا المتنج",
};
...
Map<String, String> errorMessagesEn = {
  ...
  AppText.deleteCategory: "Delete Category",
  AppText.deleteItem: "Delete Item",
  AppText.areYouSureYouWantToDeleteThisOrder:
